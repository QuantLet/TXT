...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **TXTfpbsupervised** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
Description : 'Estimates regularized linear model for sentiment classification with stochastic
gradient descent (SGD) learning. The results are evaluated by using the training set of Malo et al.
...
before usage: os, io, nltk, pickle, sklearn, pandas, numpy.'

Keywords : 'text mining, data mining, counts, sentiment, classification, support vector machine,
L1-norm penalty'

Keywords[new] : text, web data, nlp, tokenization, opinion mining

See also : 'TXTfpblexical, TXTBreweries, TXTSimulation, TXTSimulationAttention, TXTnlp, TXTMcDbl,
TXTMcDlm'
